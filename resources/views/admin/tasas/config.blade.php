...
<form method="POST" action="{{ route('admin.tasas.config.update') }}"
    ...
    {{-- Textos TinyMCE --}}
    <div class="admin-form-group full mb-24">
    ...
    <div class="admin-form-group full mb-32">
    ...
    {{-- Banner --}}
    <h3 class="admin-section-h3">Banner promocional</h3>

    <div class="admin-form-group mb-16">
    ...
    <div class="admin-form-group full mb-32">
        ...
        @if($config->banner_imagen_url)
            <div class="tasas-archivo-actual mt-10">
                <i class="fa-solid fa-image"></i>
                <span>Banner actual cargado</span>
                <a href="{{ $config->banner_imagen_url }}" target="_blank" class="text-sm">ver</a>
            </div>
        @endif
    </div>
    ...
    <h3 class="admin-section-h3">Botón "Consulta y formas de pago de tasas"</h3>

    <fieldset class="fieldset-clean mb-16">
        ...
        <label class="tasas-radio-label mt-8">
    ...
    <div id="btn-consulta-archivo" class="tasas-config-panel d-none">
    ...
    <h3 class="admin-section-h3">Botón "Ordenanza Impositiva Vigente"</h3>
    ...
    <div id="btn-ordenanza-archivo" class="tasas-config-panel d-none">
...
function toggleBtn(btn, val) {
    ...
    urlPanel.classList.toggle('d-none', val !== 'url');
    archivoPanel.classList.toggle('d-none', val !== 'archivo');
    urlInput.disabled = val !== 'url';
}
