...
<form method="POST" action="{{ route('admin.carnet.config.update') }}" class="admin-form-card">
    ...
    {{-- Alertas --}}
    <h3 class="admin-section-h3">Cajas de alerta</h3>

    <div class="admin-form-group full mb-16">
    ...
    {{-- Paso 1 --}}
    <h3 class="admin-section-h3">Paso 1</h3>
    <div class="admin-form-group full mb-12">
    ...
    {{-- Paso 2 --}}
    <h3 class="admin-section-h3">Paso 2</h3>
    <div class="admin-form-group full mb-12">
    ...
    {{-- Paso 3 --}}
    <h3 class="admin-section-h3">Paso 3</h3>
    <div class="admin-form-group full mb-12">
    ...
    {{-- Paso 4 --}}
    <h3 class="admin-section-h3">Paso 4</h3>
    <div class="admin-form-group full mb-12">
    ...
    {{-- Licencia digital --}}
    <h3 class="admin-section-h3">Sección Licencia Digital</h3>
    <div class="admin-form-group full mb-28">
