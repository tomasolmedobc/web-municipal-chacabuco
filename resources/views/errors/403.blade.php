...
<head>
    ...
    <title>Acceso denegado — Municipalidad de Chacabuco</title>
    <style>
...
<body>
    ...
    <main>
        <div class="card">
            ...
            <p>No tenés permiso para acceder a esta sección.<br>Si creés que es un error, contactá al administrador.</p>
