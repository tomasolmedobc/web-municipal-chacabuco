...
_Generated: 2026-06-18T15:26:58.938Z_
...
Workspace `mcp.json` _(folder: chacabuco)_

- **c:\laragon\www\chacabuco\.mcp.json** — _File missing_

_No active workspace servers in mcp.json._

## MCP — user profile

- **C:\Users\Administrador\.claude.json** — _File exists — no servers defined_
