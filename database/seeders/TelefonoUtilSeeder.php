...
class TelefonoUtilSeeder extends Seeder
{
    public function run(): void
    {
        if (DB::table('telefonos_utiles')->exists()) {
            $this->command->warn('La tabla ya tiene datos. Abortando para evitar duplicados.');
            return;
        }
        ...
        $this->command->info(count($rows) . ' teléfonos útiles insertados correctamente.');
    }
}
